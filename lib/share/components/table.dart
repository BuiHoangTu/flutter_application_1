    ...
    return Column(
      children: [
        Container(
          ...
          decoration: const BoxDecoration(color: Color(0xFFE8D6D4)),
          child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          color: const Color(0xFF904A43),
                                          border: Border.all(
                                            color: const Color(0xFF808080),
                                            // top: BorderSide(color: Color(0xFF808080)),
                                            // right: BorderSide(color: Color(0xFF808080)),
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          border: Border.all(
                                            ...
                                            // bottom: const BorderSide(width: 1, color: Color(0xFF808080)),
                                          ),
                                        ),
                                        child: Row(
                                          mainAxisSize: MainAxisSize.min,
